        ...
        <tbody>
          {allEpisodes.map((episode,index) =>{
            return <tr key={episode.id}>  
             ...
             <td>
               <button type="button" onClick={()=>{playList(episodeList, index + lastestEpisodes.length)}}><img src="/play-green.svg "alt="Tocar Episodio"></img> </button>
             </td>
